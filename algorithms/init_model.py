...
class Model:
    ...
    # nb_class:     number of class labels
        ...
        if (options.task_type == 'bc'):
            ...
            if (UPmethod == 'PERCEPTRON' or UPmethod == 'PA_L1' or UPmethod == 'PA_L2'):
            ...
            elif (UPmethod == 'PA1_L1' or UPmethod == 'PA1_L2'  or UPmethod == 'PA2_L1'  or UPmethod == 'PA2_L2'):
                self.bias   = options.bias
                self.p_kernel_degree = options.p_kernel_degree
                self.C = options.C
                
            elif (UPmethod == 'OGD_1' or UPmethod == 'OGD_2' or UPmethod == 'CSOGD_1' or UPmethod == 'CSOGD_2'):
                self.bias        = options.bias
                self.p_kernel_degree = options.p_kernel_degree
