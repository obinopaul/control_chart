...
def plot_performance_metric(abtype, algorithm, metric, x_lim, y_lim):
    ...
    for w in sorted_window_lengths:
        ...
        plt.plot(t_values, y_values, marker='o', label=f'm={w}')

    plt.xlabel('Abnormal Parameter', fontsize=20)
    # plt.ylabel(metric, fontsize=20)
    plt.ylabel("CER", fontsize=20)
    ...
    plt.grid(False)
    plt.legend(fontsize=23)  # You can customize fontsize or location if needed

    save_dir = os.path.join('plot_CER', f'abtype{abtype}')
