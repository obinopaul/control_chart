...
class TimeSeriesDataGenerator:
    ...
    def generate_binary_class_data(self, abtype):
        ...
        # labels = np.hstack((np.zeros(self.a), np.ones(self.b))) 
...
# python data_generator.py -t bc -d binary_synthetic_data.libsvm -w 48 --t 0.5 -a 20 -b 10 -m 1 --abtype 1

# For multiclass classification:
# python data_generator.py -t mc -d multiclass_synthetic_data.libsvm -w 48 --t 0.5 -a 20 -b 10 -m 1
