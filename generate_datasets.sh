...
source /ourdisk/hpc/disc/obinopaul/auto_archive_notyet/tape_2copies/CCPR/libol_env/bin/activate 

# Run the Python script
python -u /ourdisk/hpc/disc/obinopaul/auto_archive_notyet/tape_2copies/CCPR/generate_datasets.py $SLURM_ARRAY_TASK_ID