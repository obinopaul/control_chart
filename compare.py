...
def compare(task_type, dataset_name, file_format, nb_runs, save_path, print_results = True, showPlot = True):
    ...
    if task_type == 'bc':
        algorithms = ['Gaussian_Kernel_Perceptron','PA1_L1', 'PA1_L2','PA2_L1','PA2_L2','OGD_1', 'OGD_2','Gaussian_Kernel_OGD', 'OGD', 'PA', 'PA1', 'PA2', 'PA1_Csplit', 'PA2_Csplit', 'PA_L1', 'PA_L2', 'PA_I_L1', 'PA_I_L2', 'PA_II_L1','PA_II_L2', 'CSRDA_1', 'CSRDA_2', 'CSTG_1', 'CSTG_2']
